...
![npm](https://img.shields.io/npm/v/ai-diagram)
![Node.js](https://img.shields.io/badge/node-%3E%3D16.0.0-brightgreen)
![License](https://img.shields.io/npm/l/ai-diagram)
![TypeScript](https://img.shields.io/badge/typescript-%3E%3D4.0-blue)

# Diagram generation and visualization utilities for documentation

Diagram generator from code. Creates architecture diagrams, flowcharts, and sequence diagrams.
## Usage
...
[![npm version](https://badge.fury.io/js/ai-diagram.svg)](https://badge.fury.io/js/ai-diagram)
